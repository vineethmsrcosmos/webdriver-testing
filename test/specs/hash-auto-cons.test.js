...
describe("cehcsk", () => {
  ...
  it.skip("checks", () => {
    ...
    $(
      "#content > div > div > div > div > div.hn-or--content > div.create-peer > div.hn-peer-form > div > div > div > select"
    ).selectByIndex(data.peer.no);
    browser.pause(3000);
    $(
      "#content > div > div > div > div > div.hn-or--content > div.create-certif > div.hn-peer-form > div > div > div > div > select"
    ).selectByIndex(data.peer.no1);
    browser.pause(3000);
    $(".s-btn").click();
    browser.pause(3000);
    $(
      "#content > div > div > div > div > div.hn-or--content > div.c-btn > div > div > a > button"
    ).click();
    browser.pause(20000);
  });
});
